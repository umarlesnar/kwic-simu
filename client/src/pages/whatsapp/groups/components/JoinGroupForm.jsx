...
import { joinGroupViaInvite } from "../utils/groupWebhookClientActions";

function JoinGroupForm({ onClose, onJoined, wba_id }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const data = await joinGroupViaInvite({
      ...
      setError(
        err.response?.data?.error ||
          err.message ||
          "Failed to join group. Check the link and try again."
      );
    } finally {
      setLoading(false);
    }
